<%-- 
    Document   : adminperfil
    Created on : 23-may-2020, 11:51:44
    Author     : ernesto
--%>
...
<html>
    ...
    <body style="background-color: #1E1E1E">
        ...
        <section class="mt-1" style="background-color: #1E1E1E; color: white;">
            <p class="h3 mt-5 mb-2 text-center">Perfil administrador</p>
            ...
            <div class="col-xl-6 offset-xl-3 col-lg-4 offset-lg-4 col-md-6 
                ...
                <form action="ActualizarAdministrador.htm" method="post">
                    <input id="foto" type="hidden" name="passwordadmin" value="<%= admin.getContraseña() %>">
                    <div class="input-group mt-3 mb-3">
                        <input name="nombre" type="text" value="<%= admin.getNombre()%>"
                    ...
                    <div class="input-group mb-4">
                        <input name="passwordadmin" type="password" 
                            class="form-control rounded-0" 
